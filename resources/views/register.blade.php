            ...
            <div class="flex justify-center">
                <div class="md:w-1/2 lg:w-11/12">
                    <div class="shadow p-6">
                        <h3 class="text-center text-white text-lg font-bold mb-4">Register User</h3>
                        <form method="POST" action="{{ route('register.custom') }}">
                            @csrf
                            <div class="mb-4">
                                <input type="text" placeholder="Name" id="name" class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-indigo-500" name="name" required autofocus>
                                @if ($errors->has('name'))
                            ...
                            <div class="text-center">
                                <button type="submit" class="bg-gray-800 text-white py-2 px-4 rounded w-full">Sign Up</button>
                            </div>
                            <div class="text-center mt-4">
                                <a href="{{ route('login') }}" class="text-blue-700">Already have an account? Login</a>
                            </div>  
                        </form>
                    </div>
                </div>
